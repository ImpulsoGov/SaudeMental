      ...
      <CardLargeGridToggleList
        cards={ [
          ...
          },
          {
            ...
            infos: [
              {
                content: 'saudemental@impulsogov.org',
                icon: 'https://media.graphassets.com/6cOfkxeyT7245Fn19kgU'
              },
              {
              ...
              blocks: [
                {
                  ...
                  description: 'Caso não se lembre do e-mail que nos forneceu para a criação do seu login e senha, entre em contato conosco pelo Whatsapp <u><a href="https://wa.me/5511942642429" target="_blank">(11) 94264-2429</a></u> nos dizendo seu nome e o seu município que nós te reenviaremos o seu e-mail cadastrado.',
                },
                {
            ...
            },
            {
              ...
              blocks: [
                ...
                },
                {
                  ...
                  description: 'Não é necessário ter nenhum tipo de prontuário ou digitalização de registro do dia-a-dia das unidades para usar o nosso painel. Os dados de CAPS são obtidos a partir das fichas RAAS e BPA que são mensalmente enviados diretamente para o Ministério da Saúde pelas unidades de saúde, secretarias de saúde ou prefeituras (o fluxo pode variar dependendo do seu município). Portanto, contanto que algum dos órgãos responsáveis esteja inserindo mensalmente os dados de RAAS e BPA no sistema do Ministério da Saúde, no fluxo que já é padrão para os municípios, sejam os prontuários físicos ou digitais, a ImpulsoGov terá acesso a todos os dados necessários para que você possa ver as informações sobre o seu município no painel de indicadores.<br></br>É importante destacar que, para garantir um melhor funcionamento do painel de indicadores para o seu município, os registros devem ser preferencialmente feitos em fichas RAAS, com exceção do acolhimento inicial que parte das fichas de BPA individualizado (BPA-i), sendo poucos os procedimentos que deveriam ser prioritariamente registrados em BPA consolidado (BPA-c).<br></br>Chamamos atenção a esse ponto porque em casos de registros feitos em BPA-c, ao invés de RAAS ou BPA-i, os dados do seu município podem parecer subnotificados, uma vez que o registro consolidado impede o acesso à individualização dos atendimentos que a RAAS e o BPA-i permitem, não sendo possível, por exemplo, contabilizar se determinado paciente está tendo uma oferta adequada de cuidado multiprofissional, ou se não aderiu ao serviço após primeiro acolhimento.',
                },
                {
                ...
                },
                {
                  ...
                  description: '<b>Para valores que parecem incorretos</b><br><br>Considerando que os dados utilizados nos indicadores são extraídos diretamente dos repositórios do Ministério da Saúde, caso algum indicador pareça incorreto, primeiro é necessário verificar se a incongruência é relacionada à subnotificação de fichas. Isso pode ocorrer principalmente em três momentos:<ul><li> Forma de registro</li><ul><li> Os registros estão sendo realizados corretamente, de forma completa, nos estabelecimentos de saúde?</li></ul><li> Envio dos registros</li><ul><li> Esses registros estão sendo enviados mensalmente para o Ministério da Saúde?</li></ul><li> Correção de inconsistências</li><ul><li> Caso o Ministério da Saúde identifique algum problema em algum registro, existe uma pessoa responsável por analisar o relatório de inconsistências e reenviar os dados?</li></ul></ul>Após checagem dos pontos acima, caso a resposta seja *Sim* para as três perguntas, entre em contato com a nossa equipe pelo formulário de suporte relatando detalhadamente qual o indicador que parece estar incorreto e em quanto difere da realidade [caso saiba valores de parâmetro].<br><br><b>Para informações desatualizadas</b><br><br>Os dados do painel de indicadores são atualizados mensalmente sempre entre a primeira e segunda semana do mês. A ImpulsoGov obtém os dados diretamente do repositório público do Ministério da Saúde, isso implica que sempre trabalharemos com um atraso de dois meses com relação a competência atual (por exemplo, se o mês vigente é março, mostraremos dados de janeiro no painel).<br><br>Caso algum indicador siga desatualizado para além de dois meses e meio em relação a competência vigente (considerando o atraso de dois meses do MS e o prazo máximo de duas semanas que levamos para atualizar os indicadores no painel), entre em contato com a nossa equipe pelo formulário de suporte.<br><br><b>Para classificação de linha de cuidado de CAPS incorreta ou CAPS não aparecendo</b><br><br>Para a listagem dos CAPS ativos e classificação de linha de cuidado nossa equipe considerou as respostas enviadas por um gestor do município no formulário <em>Informações para personalização do painel</em>, preenchido no início da parceria com a ImpulsoGov. Caso algum CAPS apareça com a linha de cuidado incorreta (por exemplo, é Álcool e Drogas e está classificado como Geral), entre em contato com a nossa equipe pelo formulário de suporte indicando qual o nome do estabelecimento, como ele está sendo exibido no painel e como deveria ser mostrado.<br>Caso algum CAPS não esteja aparecendo como um estabelecimento no painel de indicadores, entre em contato com a nossa equipe pelo formulário de suporte indicando as informações abaixo:<br><blockquote>CNES <em>[insira aqui o CNES]</em>, nome oficial: <em>[insira aqui nome oficial]</em>, apelido: <em>[insira aqui o apelido se houver]</em>, Linha de cuidado: <em>[indique se Geral ou AD]</em>, Faixa etária de cuidado: <em>[indique se adulto ou inf/juv]</em></blockquote>',
                },
                {
                  subTitle:'O que os CIDs nos gráficos de CID significam? Como encontrar um CID específico?',
                  description:'Atualmente no Painel de Indicadores os itens listados nos gráficos de CID são agrupados, ou seja, dentro de um mesmo grupo, vários CIDs podem estar inclusos. Isso significa que não é possível encontrar um CID específico diretamente no gráfico, entretanto é possível descobrir a qual grupo pertence o CID que está procurando e, a partir disso, localizar o grupo correspondente no gráfico para verificar a quantidade registrada naquele indicador. <br><br>Para facilitar o processo, criamos uma <a href="https://docs.google.com/spreadsheets/d/1pWwMG--ge0nDvAK4GmmsDyc6-Sqjn-Hs6OEInMhrR7U/edit#gid=1092568943" target="_blank" style = "text-decoration:underline">planilha</a> disponível para você usar livremente, chamada de "Correspondências CID-10". Nela você encontrará todas as correspondências entre os grupos e as categorias da CID-10. Quando se trata dos indicadores de Saúde Mental, poderá utilizar a coluna "Grupo apresentado no gráfico" (coluna G, destacada em verde) para identificar como os CIDs são agrupados nos gráficos. <br><br>Vamos dar um exemplo prático: Digamos que queira descobrir a qual grupo no gráfico pertence o diagnóstico F840, que é relacionado ao Autismo infantil. Basta abrir a planilha, procurar na coluna "Descrição do CID-10" pelo CID desejado e, uma vez encontrado, verifique na mesma linha qual é o texto na coluna "Grupo apresentado no gráfico". Neste caso, descobrirá que pertence ao grupo "Transtornos do desenvolvimento psicológico". Pronto, agora você já sabe identificar dentro de qual grupo de CID o transtorno específico se encontra. <br><br>Esperamos que a planilha facilite sua busca e seja suficiente para sanar as dúvidas referentes a quais CIDs estão dentro de cada grupo de CID listado nos gráficos do painel. Caso sua dúvida persista após acessar a <a href="https://docs.google.com/spreadsheets/d/1pWwMG--ge0nDvAK4GmmsDyc6-Sqjn-Hs6OEInMhrR7U/edit#gid=1092568943" target="_blank" style = "text-decoration:underline">planilha</a>, estamos sempre à disposição para ajudar via <a href="https://wa.me/5511942642429" target="_blank" style = "text-decoration:underline">whatsapp</a>, <a href="mailto:saudemental@impulsogov.org" target="_blank" style = "text-decoration:underline">e-mail</a> ou <a href="https://saudemental.impulsogov.org/duvidas" target="_blank" style = "text-decoration:underline">formulário de solicitação de suporte</a>.'
                },
              ]
            },
            {
